...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('dashboard-mah') }}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu ">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="d-none d-md-inline">{{ Auth::guard('mahasiswa')->user()->name }}</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">

          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-users mr-2"></i> Mahasiswa</a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item"
  ...
  <aside class="main-sidebar sidebar-light-olive elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('dashboard-mah') }}" class="brand-link text-center">
    ...
    <div class="sidebar">
      ...
      <div class="user-header ">
        ...
        <div class="info pt-2 text-center">
            <h5 class="d-none d-md-inline brand-text"> {{ Auth::guard('mahasiswa')->user()->name }}</h5>
          </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="{{ route('dashboard-mah') }}" class="nav-link active">
